...
package com.schillingcoin.schillingcoinj.tools;
...
import com.schillingcoin.schillingcoinj.crypto.MnemonicException;
...
import com.schillingcoin.schillingcoinj.store.*;
...
import com.schillingcoin.schillingcoinj.wallet.DeterministicUpgradeRequiredException;
...
import static com.schillingcoin.schillingcoinj.core.Coin.parseCoin;
...
public class WalletTool {
    ...
    private static com.schillingcoin.schillingcoinj.protocols.payments.Protos.PaymentRequest paymentRequest;
        ...
        if (location.startsWith("http") || location.startsWith("peercoin")) {
            try {
                ...
                if (location.startsWith("http")) {
                    ...
                    SchillingcoinURI paymentRequestURI = new SchillingcoinURI(location);
            ...
            try {
                paymentRequest = com.schillingcoin.schillingcoinj.protocols.payments.Protos.PaymentRequest.newBuilder().mergeFrom(stream).build();
            } catch(IOException e) {
