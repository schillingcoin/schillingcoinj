...
import com.schillingcoin.schillingcoinj.core.Transaction.SigHash;
...
public class FullBlockTestGenerator {
    ...
    public RuleList getBlocksToTest(boolean addSigExpensiveBlocks, boolean runLargeReorgs, File blockStorageFile) throws ScriptException, ProtocolException, IOException {
        ...
        // Extend the b24 chain to make sure schillingcoin isn't accepting b24
        ...
        // Extend the b26 chain to make sure schillingcoin isn't accepting b26
        ...
        // Extend the b28 chain to make sure schillingcoin isn't accepting b28
        ...
        Block b56;
        try {
            b56 = new Block(params, b57.serialize());
        ...
        Block b71 = new Block(params, b72.serialize());
