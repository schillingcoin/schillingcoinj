...
public class SchillingcoinSerializerTest {
    ...
    public void testAddr() throws Exception {
        SchillingcoinSerializer bs = new SchillingcoinSerializer(MainNetParams.get());
    ...
    public void testLazyParsing()  throws Exception {
        SchillingcoinSerializer bs = new SchillingcoinSerializer(MainNetParams.get(), true, false);
    ...
    private void testCachedParsing(boolean lazy)  throws Exception {
        SchillingcoinSerializer bs = new SchillingcoinSerializer(MainNetParams.get(), lazy, true);
    ...
    @Test
    public void testSchillingcoinPacketHeader() {
        try {
            new SchillingcoinSerializer.SchillingcoinPacketHeader(ByteBuffer.wrap(new byte[]{0}));
            fail();
        ...
        try {
            new SchillingcoinSerializer.SchillingcoinPacketHeader(ByteBuffer.wrap(wrongMessageLength));
            fail();
    ...
    public void testSeekPastMagicBytes() {
        ...
        try {
            new SchillingcoinSerializer(MainNetParams.get()).seekPastMagicBytes(ByteBuffer.wrap(brokenMessage));
            fail();
        } catch (BufferUnderflowException e) {
            // expected
        }
