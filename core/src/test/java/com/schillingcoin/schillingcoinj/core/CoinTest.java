...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 OES", COIN.toFriendlyString());
        assertEquals("1.23 OES", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 OES", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 OES", valueOf(1, 23).negate().toFriendlyString());
    }
