...
import static com.schillingcoin.schillingcoinj.core.Coin.CENT;
import static com.schillingcoin.schillingcoinj.core.Coin.COIN;
import static com.schillingcoin.schillingcoinj.core.Coin.SATOSHI;
import static com.schillingcoin.schillingcoinj.core.Coin.ZERO;
...
public class MonetaryFormatTest {
    ...
    private static final MonetaryFormat NO_CODE = MonetaryFormat.OES.noCode();
    ...
    public void standardCodes() throws Exception {
        assertEquals("OES 0.00", MonetaryFormat.OES.format(Coin.ZERO).toString());
        assertEquals("mOES 0.00", MonetaryFormat.MOES.format(Coin.ZERO).toString());
        assertEquals("µOES 0", MonetaryFormat.UOES.format(Coin.ZERO).toString());
    }

    @Test
    public void customCode() throws Exception {
        assertEquals("dOES 0", MonetaryFormat.UOES.code(1, "dOES").shift(1).format(Coin.ZERO).toString());
    }

    @Test
    public void codeOrientation() throws Exception {
        assertEquals("OES 0.00", MonetaryFormat.OES.prefixCode().format(Coin.ZERO).toString());
        assertEquals("0.00 OES", MonetaryFormat.OES.postfixCode().format(Coin.ZERO).toString());
    }

    @Test
    public void codeSeparator() throws Exception {
        assertEquals("OES@0.00", MonetaryFormat.OES.codeSeparator('@').format(Coin.ZERO).toString());
    }

    @Test(expected = NumberFormatException.class)
    public void missingCode() throws Exception {
        MonetaryFormat.UOES.shift(1).format(Coin.ZERO);
    }
    ...
    public void parse() throws Exception {
        ...
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MOES.parse("1"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MOES.parse("1.0"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MOES.parse("01.0000000000"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MOES.positiveSign('+').parse("+1.0"));
        assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MOES.parse("-1"));
        assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MOES.parse("-1.0"));

        assertEquals(Coin.MICROCOIN, MonetaryFormat.UOES.parse("1"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UOES.parse("1.0"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UOES.parse("01.0000000000"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UOES.positiveSign('+').parse("+1.0"));
        assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UOES.parse("-1"));
        assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UOES.parse("-1.0"));
