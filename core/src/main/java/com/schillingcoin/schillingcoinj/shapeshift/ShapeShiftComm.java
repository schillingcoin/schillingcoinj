...
package com.schillingcoin.schillingcoinj.shapeshift;
...
/**
 * Implements {@link com.schillingcoin.schillingcoinj.shapeshift.ShapeShiftInterface}
 *
...
public class ShapeShiftComm extends ShapeShiftInterface {
	...
	public void sendAmount(final ShapeShiftCoin destCoin, Address destAddr, ShapeShiftMonetary amount, Address refund) {
		...
		try {
			jsonRequest.put("pair", "oes_" + destCoin.coinCode);
	...
	public void limit(ShapeShiftCoin destCoin) {
		client.get(API_URL + "limit/oes_" + destCoin.coinCode, new ResponseCallback() {
	...
	public void rate(ShapeShiftCoin destCoin) {
		client.get(API_URL + "rate/" + destCoin.coinCode + "_oes", new ResponseCallback() {
	...
	public void marketInfo(final ShapeShiftCoin destCoin) {
		client.get(API_URL + "marketinfo/oes_" + destCoin.coinCode, new ResponseCallback() {
