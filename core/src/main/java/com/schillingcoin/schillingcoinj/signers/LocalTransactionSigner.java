 ...
 */
package com.schillingcoin.schillingcoinj.signers;
...
/**
 * <p>{@link TransactionSigner} implementation for signing inputs using keys from provided {@link com.schillingcoin.schillingcoinj.wallet.KeyBag}.</p>
 ...
 * <p>This signer always uses {@link com.schillingcoin.schillingcoinj.core.Transaction.SigHash#ALL} signing mode.</p>
 */
    ...
    public boolean signInputs(ProposedTransaction propTx, KeyBag keyBag) {
        ...
        for (int i = 0; i < numInputs; i++) {
            ...
            try {
                ...
                int sigIndex = 0;
                inputScript = scriptPubKey.getScriptSigWithSignature(inputScript, signature.encodeToSchillingcoin(), sigIndex);
