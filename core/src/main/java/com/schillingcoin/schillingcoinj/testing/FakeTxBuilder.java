...
package com.schillingcoin.schillingcoinj.testing;
...
public class FakeTxBuilder {
    ...
    /**
     * Transaction[0] is a feeder transaction, supplying OES to Transaction[1]
     */
    public static Transaction[] createFakeTx(NetworkParameters params, Coin value,
                                             Address to, Address from) {
        // Create fake TXes of sufficient realism to exercise the unit tests. This transaction send OES from the
    ...
    public static Transaction roundTripTransaction(NetworkParameters params, Transaction tx) {
        try {
            SchillingcoinSerializer bs = new SchillingcoinSerializer(params);
    ...
    public static DoubleSpends createFakeDoubleSpendTxns(NetworkParameters params, Address to) {
        ...
        try {
            doubleSpends.t1 = new Transaction(params, doubleSpends.t1.serialize());
            doubleSpends.t2 = new Transaction(params, doubleSpends.t2.serialize());
