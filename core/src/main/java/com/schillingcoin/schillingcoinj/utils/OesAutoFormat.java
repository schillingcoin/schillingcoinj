...
/**
 * <p>This class, a concrete extension of {@link OesFormat}, is distinguished by its
 ...
 * OesFormat} class, and further information beyond that is in the documentation for the {@link
...
public final class OesAutoFormat extends OesFormat {
    ...
    public enum Style {
        ...
        /** Constant for the formatting style that uses a currency code, e.g., "OES". */
        CODE {
        ...
        /** Constant for the formatting style that uses a currency symbol, e.g., "S". */
        SYMBOL {
            @Override void apply(DecimalFormat decimalFormat) {
    ...
    /** Constructor */
    protected OesAutoFormat(Locale locale, Style style, int fractionPlaces) {
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof OesAutoFormat)) return false;
        return super.equals((OesAutoFormat)o);
    }
