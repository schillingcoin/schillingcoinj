...
import static com.schillingcoin.schillingcoinj.core.Coin.SMALLEST_UNIT_EXPONENT;
...
/**
 * <p>This class, a concrete extension of {@link OesFormat}, is distinguished in that each
 ...
 * custom pattern using either the {@link OesFormat.Builder#localizedPattern} or {@link OesFormat.Builder#localizedPattern()} methods, as described in the documentation for the {@link OesFormat.Builder}
 * class.<ol>
 *
 * <p>A more detailed explanation, including examples, is in the documentation for the
 * {@link OesFormat} class, and further information beyond that is in the documentation for the
...
public final class OesFixedFormat extends OesFormat {
     ...
     * denomination is millipeercoins, then this method will return <code>"mOES"</code>,
     * assuming the default base currency-code is not overridden using a
     * {@link OesFormat.Builder}.  */
     ...
     * millipeercoins, this method by default returns <code>"₥S"</code>, depending on the
     * locale.  */
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof OesFixedFormat)) return false;
        OesFixedFormat other = (OesFixedFormat)o;
