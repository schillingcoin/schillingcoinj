...
public final class MonetaryFormat {
    ...
    /** Standard format for the OES denomination. */
    public static final MonetaryFormat OES = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 2);
    /** Standard format for the mOES denomination. */
    public static final MonetaryFormat MOES = new MonetaryFormat().shift(3).minDecimals(2).optionalDecimals(1);
    /** Standard format for the µOES denomination. */
    public static final MonetaryFormat UOES = new MonetaryFormat().shift(6).minDecimals(0).optionalDecimals(0);
    /** Standard format for fiat amounts. */
    public static final MonetaryFormat FIAT = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 1);
    /** Currency code for base 1 Peercoin. */
    public static final String CODE_OES = "OES";
    /** Currency code for base 1/1000 Peercoin. */
    public static final String CODE_MOES = "mOES";
    /** Currency code for base 1/1000000 Peercoin. */
    public static final String CODE_UOES = "µOES";
    ...
    /**
     * Set number of digits to shift the decimal separator to the right, coming from the standard OES notation that was
    ...
    public MonetaryFormat() {
        ...
        this.codes.put(0, CODE_OES);
        this.codes.put(3, CODE_MOES);
        this.codes.put(6, CODE_UOES);
        this.codeSeparator = ' ';
    ...
    /**
     * Parse a human readable coin value to a {@link com.schillingcoin.schillingcoinj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link com.schillingcoin.schillingcoinj.core.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
    ...
    /**
     * Gets a {@link com.schillingcoin.schillingcoinj.shapeshift.ShapeShiftMonetary} for a string formatted with the MonetaryFormat
     *
