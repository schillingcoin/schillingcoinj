...
/**
 * A TransactionSignature wraps an {@link com.schillingcoin.schillingcoinj.core.ECKey.ECDSASignature} and adds methods for handling
...
public class TransactionSignature extends ECKey.ECDSASignature {
     ...
     */
    public byte[] encodeToSchillingcoin() {
        try {
