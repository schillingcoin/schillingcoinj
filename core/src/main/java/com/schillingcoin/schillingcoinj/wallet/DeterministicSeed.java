...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link com.schillingcoin.schillingcoinj.crypto.MnemonicCode} for more
     ...
     *
     * @throws com.schillingcoin.schillingcoinj.crypto.MnemonicException if check fails
     */
