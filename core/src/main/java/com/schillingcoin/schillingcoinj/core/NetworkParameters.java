...
import com.schillingcoin.schillingcoinj.params.*;
...
/**
 * <p>NetworkParameters contains the data needed for working with an instantiation of a Schillingcoin chain.</p>
 *
...
public abstract class NetworkParameters implements Serializable {
    ...
    public static final String ID_MAINNET = "com.schillingcoin.production";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "com.schillingcoin.schillingcoinj.unittest";
     ...
     *
     * <p>The first block in every chain is a well known constant shared between all Schillingcoin implemenetations. For a
    ...
    /**
     * First byte of a base58 encoded address. See {@link com.schillingcoin.schillingcoinj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link com.schillingcoin.schillingcoinj.core.DumpedPrivateKey}. */
     ...
     * test and production Schillingcoin networks use 2 weeks (1209600 seconds).
     */
    ...
    /** How many blocks pass between difficulty adjustment periods. Schillingcoin standardises this to be 2015. */
    ...
    /**
     * The key used to sign {@link com.schillingcoin.schillingcoinj.core.AlertMessage}s. You can use {@link com.schillingcoin.schillingcoinj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
