...
public final class Coin implements Monetary, Comparable<Coin>, Serializable {
    ...
    /**
     * Number of decimals for one Schillingcoin. This constant is useful for quick adapting to other coins because a lot of
     * constants derive from it.
     */
    public static final int SMALLEST_UNIT_EXPONENT = 6;

    /**
     * The number of satoshis equal to one schillingcoin.
     */
    ...
    /**
     * 0.01 Schillingcoins. This unit is not really used much.
     */
    public static final Coin CENT = COIN.divide(100);

    /**
     * 0.001 Schillingcoins, also known as 1 mOES.
     */
    public static final Coin MILLICOIN = COIN.divide(1000);

    /**
     * 0.000001 Schillingcoin, also known as 1 µOES or 1 uOES.
     */
    public static final Coin MICROCOIN = MILLICOIN.divide(1000);

    /**
     * A satoshi is the smallest unit that can be transferred. 1 million of them fit into a Schillingcoin.
     */
    ...
    private Coin(final long satoshis) {
        checkArgument(-MAX_SATOSHIS <= satoshis && satoshis <= MAX_SATOSHIS,
            "%s satoshis exceeds maximum possible quantity of Schillingcoin.", satoshis);
        this.value = satoshis;
    }
    ...
    private static final MonetaryFormat FRIENDLY_FORMAT = MonetaryFormat.OES.minDecimals(2).repeatOptionalDecimals(1, 4).postfixCode();
    ...
    private static final MonetaryFormat PLAIN_FORMAT = MonetaryFormat.OES.minDecimals(0).repeatOptionalDecimals(1, 6).noCode();

    /**
     * <p>
     * Returns the value as a plain string denominated in OES.
     * The result is unformatted with no trailing zeroes.
     * For instance, a value of 150000 satoshis gives an output string of "0.0015" OES
     * </p>
     */
