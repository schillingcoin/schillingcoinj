...
public class VersionMessage extends Message {
    ...
    public static final String SCHILLINGCOINJ_VERSION = "0.14.0";
    /** The value that is prepended to the subVer field of this application. */
    public static final String LIBRARY_SUBVER = "/SchillingcoinJ:" + SCHILLINGCOINJ_VERSION + "/";
    ...
    public void serializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.serialize(buf);
            // Their address.
            theirAddr.serialize(buf);
        } catch (UnknownHostException e) {
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for SchillingcoinJ
     * users might look like "/SchillingcoinJ:0.4-SNAPSHOT/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/SchillingcoinJ:1.0/MultiBit:1.0(Windows)/. Therefore the / ( and ) characters are reserved in all these
