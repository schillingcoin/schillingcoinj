...
package com.schillingcoin.schillingcoinj.core;
...
import com.schillingcoin.schillingcoinj.protocols.payments.Protos.PaymentDetails;
import com.schillingcoin.schillingcoinj.core.TransactionConfidence.ConfidenceType;
import com.schillingcoin.schillingcoinj.crypto.*;
import com.schillingcoin.schillingcoinj.params.UnitTestParams;
import com.schillingcoin.schillingcoinj.script.Script;
import com.schillingcoin.schillingcoinj.script.ScriptBuilder;
import com.schillingcoin.schillingcoinj.script.ScriptChunk;
import com.schillingcoin.schillingcoinj.signers.LocalTransactionSigner;
import com.schillingcoin.schillingcoinj.signers.MissingSigResolutionSigner;
import com.schillingcoin.schillingcoinj.signers.TransactionSigner;
...
import com.schillingcoin.schillingcoinj.utils.BaseTaggableObject;
import com.schillingcoin.schillingcoinj.utils.ExchangeRate;
import com.schillingcoin.schillingcoinj.utils.ListenerRegistration;
import com.schillingcoin.schillingcoinj.utils.Threading;
import com.schillingcoin.schillingcoinj.wallet.*;
import com.schillingcoin.schillingcoinj.wallet.Protos.Wallet.EncryptionType;
import com.schillingcoin.schillingcoinj.wallet.WalletTransaction.Pool;
 ...
 * of the Schillingcoin protocol.</p>
 *
 ...
 *
 * <p>Wallets can be serialized using either Java serialization - this is not compatible across versions of schillingcoinj,
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.schillingcoin.schillingcoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject implements Serializable, BlockChainListener, PeerFilterProvider, KeyBag, TransactionBag {
     ...
     * {@link com.schillingcoin.schillingcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(com.schillingcoin.schillingcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.schillingcoin.schillingcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(com.schillingcoin.schillingcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(com.schillingcoin.schillingcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.schillingcoin.schillingcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link com.schillingcoin.schillingcoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link com.schillingcoin.schillingcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(com.schillingcoin.schillingcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.schillingcoin.schillingcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(com.schillingcoin.schillingcoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(com.schillingcoin.schillingcoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.schillingcoin.schillingcoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of schillingcoinj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.schillingcoin.schillingcoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link com.schillingcoin.schillingcoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link com.schillingcoin.schillingcoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link com.schillingcoin.schillingcoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws com.schillingcoin.schillingcoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.schillingcoin.schillingcoinj.crypto.KeyCrypter,
     ...
     * {@link com.schillingcoin.schillingcoinj.crypto.KeyCrypterScrypt}.
     *
    ...
    private void processTxFromBestChain(Transaction tx, boolean forceAddToPool) throws VerificationException {
        ...
        if (isDeadCoinbase) {
            ...
            // we could. Schillingcoin nodes on the network have deleted the dependent transactions from their mempools
        ...
        for (TransactionInput input : tx.getInputs()) {
            ...
            if (result == TransactionInput.ConnectionResult.ALREADY_SPENT) {
                if (fromChain) {
                    ...
                    log.warn("{}: {}", tx.getHash(), Utils.HEX.encode(tx.unsafeSerialize()));
                    Transaction other = input.getConnectedOutput().getSpentBy().getParentTransaction();
                    log.warn("{}: {}", other.getHash(), Utils.HEX.encode(tx.unsafeSerialize()));
                }
    ...
    public String toString(boolean includePrivateKeys, boolean includeTransactions, boolean includeExtensions,
        ...
        try {
            ...
            builder.append(String.format("Wallet containing %s OES (available: %s OES) in:%n",
     ...
     * of {@link com.schillingcoin.schillingcoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link com.schillingcoin.schillingcoinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public static class SendResult {
        /** The Schillingcoin transaction message that moves the money. */
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link com.schillingcoin.schillingcoinj.signers.TransactionSigner.MissingSignatureException}
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.schillingcoin.schillingcoinj.core.Wallet#getBalance()} - the fees required
        ...
        /**
         * If not null, the {@link com.schillingcoin.schillingcoinj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
     ...
     *
     * @param address The Schillingcoin address to send the money to.
     ...
     * @throws ExceededMaxTransactionSize if the resultant transaction is too big for Schillingcoin to process (try breaking up the amounts of value)
     */
    ...
    public void completeTx(SendRequest req) throws InsufficientMoneyException {
        ...
        try {
            ...
            // Check size.
            int size = req.tx.serialize().length;
    ...
    private boolean adjustOutputDownwardsForFee(Transaction tx, CoinSelection coinSelection, Coin baseFee, Coin feePerKb) {
        ...
        // schillingcoin: Always add required fee
                ...
                for (int i = 0; i < tx.getOutputs().size(); i++) {
                    ...
                    try {
                        if (isTxOutputBloomFilterable(out)) {
                            ...
                            filter.insert(outPoint.serialize());
                        }
                    } catch (ScriptException e) {
    ...
    public FeeCalculation calculateFee(SendRequest req, Coin value, List<TransactionInput> originalInputs,
        ...
        while (true) {
            ...
            // schillingcoin: We always include the required fee
            ...
            // If change is < 0.01 OES, we will need to discard the change
            ...
            if (change.signum() > 0) {
                ...
                size += changeOutput.serialize().length + VarInt.sizeOf(req.tx.getOutputs().size()) - VarInt.sizeOf(req.tx.getOutputs().size() - 1);
     ...
     * sending transactions to the Schillingcoin network by default. Some sendCoins methods let you specify a broadcaster
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.schillingcoin.schillingcoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws com.schillingcoin.schillingcoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
     ...
     * {@link com.schillingcoin.schillingcoinj.core.PeerFilterProvider} interface and generally should not be used directly by apps.
