...
import com.schillingcoin.schillingcoinj.wallet.DefaultRiskAnalysis;
import com.schillingcoin.schillingcoinj.wallet.KeyBag;
import com.schillingcoin.schillingcoinj.wallet.RedeemData;
...
public class TransactionInput extends ChildMessage implements Serializable {
     ...
     * "from address" is not well defined in Schillingcoin and you should not assume that senders of a transaction can
     ...
     * in nodes memory pools if the existing version is time locked. See the Contracts page on the Schillingcoin wiki for
     ...
     * @see TransactionOutPoint#getConnectedRedeemData(com.schillingcoin.schillingcoinj.wallet.KeyBag)
     */
    @Nullable
    ...
    public TransactionInput duplicateDetached() {
        return new TransactionInput(params, null, serialize(), 0);
    }
