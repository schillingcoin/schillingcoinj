 ...
 *
 * <p>TransactionConfidence is updated via the {@link com.schillingcoin.schillingcoinj.core.TransactionConfidence#notifyWorkDone(Block)}
 * method to ensure the block depth and work done are up to date.</p>
 * To make a copy that won't be changed, use {@link com.schillingcoin.schillingcoinj.core.TransactionConfidence#duplicate()}.
 */
public class TransactionConfidence implements Serializable {
    ...
    public enum ConfidenceType {
         ...
         * how many announce it, using {@link com.schillingcoin.schillingcoinj.core.TransactionConfidence#numBroadcastPeers()}.
    ...
    public interface Listener {
        ...
        public enum ChangeReason {
            /**
             * Occurs when the type returned by {@link com.schillingcoin.schillingcoinj.core.TransactionConfidence#getConfidenceType()}
     ...
     * and so on. This information is useful for {@link com.schillingcoin.schillingcoinj.wallet.CoinSelector} implementations to risk analyze
