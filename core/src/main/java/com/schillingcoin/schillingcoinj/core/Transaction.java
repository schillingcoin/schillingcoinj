...
import com.schillingcoin.schillingcoinj.crypto.TransactionSignature;
import com.schillingcoin.schillingcoinj.script.Script;
import com.schillingcoin.schillingcoinj.script.ScriptBuilder;
import com.schillingcoin.schillingcoinj.script.ScriptOpCodes;
...
import static com.schillingcoin.schillingcoinj.core.Utils.*;
import static com.google.common.base.Preconditions.checkState;

/**
 * <p>A transaction represents the movement of coins from some addresses to some other addresses. It can also represent
 * the minting of new coins. A Transaction object corresponds to the equivalent in the Schillingcoin C++ implementation.</p>
 *
 * <p>Transactions are the fundamental atoms of Schillingcoin and have many powerful features. Read
 ...
 *
 * <p>All Schillingcoin transactions are at risk of being reversed, though the risk is much less than with traditional payment
...
public class Transaction extends ChildMessage implements Serializable {
    ...
    // These are serialized in both schillingcoin and java serialization.
     ...
     * @param payload Schillingcoin protocol formatted byte array containing message content.
    ...
    /**
     * Used by SchillingcoinSerializer.  The serializer has to calculate a hash for checksumming so to
     ...
     * value is determined by a formula that all implementations of Schillingcoin share. In 2011 the value of a coinbase
    ...
    public void clearInputs() {
        ...
        this.length = this.serialize().length;
    }
     ...
     * and requires external synchronization. Please refer to general documentation on Schillingcoin scripting and contracts
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.schillingcoin.schillingcoinj.script.Script, ECKey, com.schillingcoin.schillingcoinj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.schillingcoin.schillingcoinj.core.Transaction.SigHash, boolean)}
    ...
    public synchronized Sha256Hash hashForSignature(int inputIndex, byte[] connectedScript, byte sigHashType) {
        ...
        try {
            ...
            // is a legacy holdover from a previous, broken design of executing scripts that shipped in Schillingcoin 0.1.
            ...
            if ((sigHashType & 0x1f) == (SigHash.NONE.ordinal() + 1)) {
                ...
                if (inputIndex >= this.outputs.size()) {
                    ...
                    // Schillingcoin implementation. The reference client also contains a bug in handling this case:
     ...
     * since Schillingcoin 0.8+ a transaction that did not end its lock period (non final) is considered to be non
