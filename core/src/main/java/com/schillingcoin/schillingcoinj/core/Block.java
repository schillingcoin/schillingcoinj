...
import static com.schillingcoin.schillingcoinj.core.Utils.doubleDigest;
import static com.schillingcoin.schillingcoinj.core.Utils.doubleDigestTwoBuffers;

/**
 * <p>A block is a group of transactions, and is one of the fundamental data structures of the Schillingcoin system.
...
public class Block extends Message {
     ...
     * upgrade everyone to change this, so Schillingcoin can continue to grow. For now it exists as an anti-DoS measure to
    ...
    /** Constructs a block object from the Schillingcoin wire format. */
    ...
    /**
     * Contruct a block object from the Schillingcoin wire format.
    ...
    private void parseTransactions() throws ProtocolException {
        ...
        if (payload.length == cursor || payload.length - 1 == cursor) { // Include the -1 case for the null byte which is required for schillingcoin
    ...
    public int getOptimalEncodingMessageSize() {
        ...
        if (optimalEncodingMessageSize != 0)
            return optimalEncodingMessageSize;
        optimalEncodingMessageSize = serialize().length;
        return optimalEncodingMessageSize;
    }
    ...
    /** Returns the version of the block data structure as defined by the Schillingcoin protocol. */
     ...
     * {@link com.schillingcoin.schillingcoinj.core.Block#getDifficultyTargetAsInteger()}. Note that this is <b>not</b> the same as
     * the difficulty value reported by the Schillingcoin "getdifficulty" RPC that you may see on various block explorers.
    ...
    void addCoinbaseTransaction(byte[] pubKeyTo, Coin value) {
        ...
        coinbase.length = coinbase.serialize().length;
