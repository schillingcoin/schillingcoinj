...
import com.schillingcoin.schillingcoinj.wallet.KeyChainEventListener;
...
public interface WalletEventListener extends KeyChainEventListener {
     ...
     * the object retrieved via {@link com.schillingcoin.schillingcoinj.core.Transaction#getConfidence()}. It's safe to modify the
