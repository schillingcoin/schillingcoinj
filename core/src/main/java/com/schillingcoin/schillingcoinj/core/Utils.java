...
/**
 * A collection of various utility methods that are helpful for working with the Schillingcoin protocol.
 * To enable debug logging from the library, run with -Dschillingcoinj.logging=true on your command line.
 */
public class Utils {
    ...
    /** The string that prefixes all text messages signed using Schillingcoin keys. */
    public static final String Schillingcoin_SIGNED_MESSAGE_HEADER = "Schillingcoin Signed Message:\n";
    public static final byte[] Schillingcoin_SIGNED_MESSAGE_HEADER_BYTES = Schillingcoin_SIGNED_MESSAGE_HEADER.getBytes(Charsets.UTF_8);
     ...
     * standard procedure in Schillingcoin. The resulting hash is in big endian form.
     */
     ...
     *
     * <p>Schillingcoin only uses this "compact" format for encoding difficulty targets, which are unsigned 256bit quantities.
     ...
     *
     * <tt><p>[24] "Schillingcoin Signed Message:\n" [message.length as a varint] message</p></tt>
     */
    public static byte[] formatMessageForSigning(String message) {
        try {
            ByteArrayOutputStream bos = new ByteArrayOutputStream();
            bos.write(Schillingcoin_SIGNED_MESSAGE_HEADER_BYTES.length);
            bos.write(Schillingcoin_SIGNED_MESSAGE_HEADER_BYTES);
