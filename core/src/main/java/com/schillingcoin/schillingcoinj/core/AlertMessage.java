 ...
 * The private keys are held by a small group of core Schillingcoin developers, and alerts may be broadcast in the event of
...
public class AlertMessage extends Message {
    ...
    void parse() throws ProtocolException {
        ...
        version = readUint32();
        // Read the timestamps. Schillingcoin uses seconds since the epoch.
