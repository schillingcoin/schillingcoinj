...
/**
 * <p>Methods to serialize and de-serialize messages to the Schillingcoin network.
 *
 ...
 * <li>Message.serializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class SchillingcoinSerializer {
    private static final Logger log = LoggerFactory.getLogger(SchillingcoinSerializer.class);
    ...
    /**
     * Constructs a SchillingcoinSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public SchillingcoinSerializer(NetworkParameters params) {
     ...
     */
    public SchillingcoinSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("SchillingcoinSerializer doesn't currently know how to serialize " + message.getClass());
        }
    ...
    public Message deserialize(ByteBuffer in) throws ProtocolException, IOException {
        // A Schillingcoin protocol message has the following format.
        //
        ...
        SchillingcoinPacketHeader header = new SchillingcoinPacketHeader(in);
     ...
     */
    public SchillingcoinPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException {
        return new SchillingcoinPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link SchillingcoinSerializer#deserializeHeader}.
     */
    public Message deserializePayload(SchillingcoinPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException {
    ...
    public static class SchillingcoinPacketHeader {
        ...
        public SchillingcoinPacketHeader(ByteBuffer in) throws ProtocolException, BufferUnderflowException {
