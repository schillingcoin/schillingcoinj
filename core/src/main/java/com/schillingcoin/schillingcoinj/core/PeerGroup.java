...
import com.schillingcoin.schillingcoinj.crypto.DRMWorkaround;
import com.schillingcoin.schillingcoinj.net.BlockingClientManager;
import com.schillingcoin.schillingcoinj.net.ClientConnectionManager;
import com.schillingcoin.schillingcoinj.net.FilterMerger;
import com.schillingcoin.schillingcoinj.net.NioClientManager;
...
import com.schillingcoin.schillingcoinj.net.discovery.TorDiscovery;
import com.schillingcoin.schillingcoinj.script.Script;
import com.schillingcoin.schillingcoinj.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
    ...
    // Minimum protocol version we will allow ourselves to connect to: Do not require bloom filtering as it doesn't exist in Schillingcoin
     ...
     *         Use {@link com.schillingcoin.schillingcoinj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.schillingcoin.schillingcoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.schillingcoin.schillingcoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.schillingcoin.schillingcoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * someone and want to know that it's valid. It's a bit of a weird hack because the current version of the Schillingcoin
     ...
     * times are available via {@link com.schillingcoin.schillingcoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.schillingcoin.schillingcoinj.core.Peer#ping()}.
     */
