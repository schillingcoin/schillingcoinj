 ...
 * Currently this includes getaddr, ping, verack as well as the special schillingcoinj class UnknownMessage
 *
 * @author git
 */
public abstract class EmptyMessage extends Message {
    ...
    @Override
    final protected void serializeToStream(OutputStream stream) throws IOException {
    }
