...
public class TransactionOutPoint extends ChildMessage implements Serializable {
    ...
    // This is not part of Schillingcoin serialization. It's included in Java serialization.
     ...
     * For P2SH scripts you can use {@link #getConnectedRedeemData(com.schillingcoin.schillingcoinj.wallet.KeyBag)} and then get the
     * key from RedeemData.
